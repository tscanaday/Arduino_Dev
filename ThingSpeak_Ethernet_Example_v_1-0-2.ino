...
const double boardVoltage = 4.9;    //  calibration value of DC voltage...
...
void loop()
{
  ...
  if(!client.connected() && (millis() - lastConnectionTime > postingInterval))
  {
    ...
    else
    {
      ...
      ThingSpeak.setField(4,(float)outdoorLight);       //  CdS Photosensor reading...
...
void PrintProgramInfoToConsole()
{
  ...
  Serial.println(F("ThingSpeak Client Example with Ethernet Shield v 1.0.2"));
  Serial.println(F("February 4, 2025"));
  Serial.println();
}
