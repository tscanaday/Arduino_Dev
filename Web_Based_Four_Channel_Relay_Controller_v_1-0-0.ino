/*
  Web_Based_Four_Channel_Relay_Controller_v_1-0-0
  ...
  02/17/2025  Initial release of source code.
*/
...
char pass[] = "YOUR PASSWORD";    //  WiFi network password...
...
int relayPin1 = 10;               //  relay 1 to pin 10...
int relayPin2 = 11;               //  relay 2 to pin 11...
int relayPin3 = 12;               //  relay 3 to pin 12...
int relayPin4 = 13;               //  relay 4 to pin 13...
...
String relayThreeState = "Off";   //  string holding state of relay 3 on form...
String relayFourState = "Off";    //  string holding state of relay 4 on form...
...
char *buttonName[] = {"Relay 1", "Relay 2", "Relay 3", "Relay 4"};
...
void setup()
{
  ...
  pinMode(relayPin3,OUTPUT);            //  relay 3 configuration as an output...
  digitalWrite(relayPin3, HIGH);        //  turn relay 3 off...

  pinMode(relayPin4,OUTPUT);            //  relay 4 configuration as an output...
  digitalWrite(relayPin4, HIGH);        //  turn relay 4 off...
  ...
  */
  ...
  Serial.println("February 17, 2025");
  Serial.println();
...
void DashboardView(WiFiClient cl)
{
  ...
  /*  RELAY 3                     */
  /********************************/
  if(relayThreeState == "Off")
  {
    // if the relay is off, set button to turn relay on...
    cl.println("<tr>");
    cl.println("<td align='left'>");
    cl.println("<font size='3' face='Trebuchet MS'>");
    cl.println(buttonName[2]);
    cl.println("</font>");
    cl.println("</td>");
    cl.println("<td>");
    cl.println("&nbsp;&nbsp;<a href=\"/relay3on\"><button>Turn ON</button></a>");
    cl.println("</td>");
    cl.println("</tr>");
  }
  else if(relayThreeState == "On")
  {
    // if the relay is on, set button to turn relay off...
    cl.println("<tr>");
    cl.println("<td align='left'>");
    ...
    cl.println("</td>");
    cl.println("<td>");
    cl.println("&nbsp;&nbsp;<a href=\"/relay3off\"><button>Turn OFF</button></a>");
    cl.println("</td>");
    cl.println("</tr>");
  }
  ...
  /*  RELAY 4                     */
  /********************************/
  if(relayFourState == "Off")
  {
    // if the relay is off, set button to turn relay on...
    cl.println("<tr>");
    cl.println("<td align='left'>");
    cl.println("<font size='3' face='Trebuchet MS'>");
    cl.println(buttonName[3]);
    cl.println("</font>");
    cl.println("</td>");
    cl.println("<td>");
    cl.println("&nbsp;&nbsp;<a href=\"/relay4on\"><button>Turn ON</button></a>");
    cl.println("</td>");
    cl.println("</tr>");
  }
  else if(relayFourState == "On")
  {
    // if the relay is on, set button to turn relay off...
    cl.println("<tr>");
    cl.println("<td align='left'>");
    ...
    cl.println("</td>");
    cl.println("<td>");
    cl.println("&nbsp;&nbsp;<a href=\"/relay4off\"><button>Turn OFF</button></a>");
    cl.println("</td>");
    cl.println("</tr>");
  }
...
void PrintBottomPartOfPage(WiFiClient cl)
{
  ...
  cr = cr + "<br />Your Name Here<br />All rights reserved<br>";
